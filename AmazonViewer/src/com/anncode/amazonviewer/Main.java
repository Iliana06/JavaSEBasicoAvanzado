 ...
 * <h1> Amazon Viewer </h1>
 * <br/>
 * Amazon Viewer es un programa que permite visualizar Movies,
 * Series con sus respectiovos Chapters, Books y Magazines. 
 ...
 * o leídos a excepción de las Magazines, estas solo pueden ser vistas 
...
public class Main {
	...
	public static void showMovies() {
		...
		do {
			...
			movies.forEach(m -> System.out.println(ai.getAndIncrement() +". "+m.getTitle() + " Visto: " + m.isViewed())); // recursividad usando lambdas1
